    ...
    <div class="col-6 d-flex flex-column h-100 justify-content-center align-items-center bg-gradient-light">
        <div class="card card-outline card-primary my-2 rounded-0 shadow">
            <div class="card-header rounded-0">
                <h3 class="card-title font-wight-bolder">Registro de cliente</h3>
            </div>
            <div class="card-body">
                <form id="aregistration-frm" action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label for="lastname" class="control-label">Segundo apellido <sup>*</sup></label>
                            <input type="text" name="lastname" id="lastname" class="form-control form-control-sm rounded-0" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label for="gender" class="control-label">Genero <sup>*</sup></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="password" class="control-label">Contraseña <sup>*</sup></label>
                        ...
                        <div class="col-md-6">
                            <label for="cpassword" class="control-label">Confirmar Contraseña <sup>*</sup></label>
                            <div class="input-group input-group-sm">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">Crear una cuenta</button>
                    </div>
                    <!-- /.col -->
                    </div>
