...
if(isset($_GET['id'])){
    ...
    echo '<script> alert("Se requiere identificación de la Inmobiliaria para acceder a la página.."); location.replace("./?page=real_estate"); </script>';
}
?>
<style>
    .view-image img{
...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title">Detalles de la propiedad: <b><?= isset($code) ? $code : "" ?></b></h4>
            <div class="card-tools">
                <a href="./?page=real_estate/manage_estate&id=<?= isset($id) ? $id : '' ?>" class="btn btn-flat btn-sm bg-gradient-primary"><i class="fa fa-edit"></i> Editar detalles</a>
                <button type="button" class="btn btn-flat btn-sm bg-gradient-danger" id="delete_estate"><i class="fa fa-trash"></i> Eliminar</button>
            </div>
        </div>
        <div class="card-body">
            <div class="row gx-4 gx-lg-5 align-items-top">
                ...
                <div class="col-md-6">
                    ...
                    <fieldset>
                        <legend class="h4 text-muted">Detalles</legend>
                        <div class="row">
                            <div class="col-6">
                                <span class="text-muted">Tipo: </span><?= isset($type) ? $type : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">Objetivo: </span><?= isset($purpose) ? $purpose : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">Area: </span><?= isset($area) ? $area : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">Precio de venta: </span><?= isset($sale_price) ? format_num($sale_price) : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">Ciudad: </span><?= isset($ciudad) ? $ciudad : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">Ubicación: </span><?= isset($ubicacion) ? $ubicacion : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">Zona: </span><?= isset($zona) ? $zona : '' ?>
                            </div>
                            <div class="col-6">
                    ...
                    <fieldset>
                        <legend class="h4 text-muted">Comodidades</legend>
                        ...
                        <?php endif; ?>
                        <?php else: ?>
                            <center><small class="text-mute"><i>No hay servicios enumerados.</i></small></center>
                        <?php endif; ?>
                    </fieldset>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="card card-outline card-info rounded-0 shadow">
                        <div class="card-header">
                            <h4 class="cart-title"><b>Detalles del agente:</b></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
...
$(function(){
    ...
    $('#delete_estate').click(function(){
        _conf("¿Estás seguro de eliminar este inmueble de forma permanente?","delete_estate",[])
    })
})
