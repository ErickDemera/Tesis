...
if(isset($_GET['id'])){
    ...
    echo '<script> alert("Se requiere el ID de la Inmobiliaria para acceder a la página."); location.replace("./?page=real_estate"); </script>';
}
?>
<style>
    .view-image img{
                ...
                <div class="col-md-6">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="text-muted">Ubicacion: </span><?= isset($ubicacion) ? $ubicacion : '' ?>
                            </div>
                            <div class="col-6">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="card card-outline card-info rounded-0 shadow">
                        <div class="card-header">
                            <h4 class="cart-title"><b>Detalle de Agente:</b></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <dl>
                                        ...
                                        <dt class="text-muted"><b>N° Telefono</b></dt>
