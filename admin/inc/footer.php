...
<footer class="main-footer text-sm">
        ...
        <div class="float-right d-none d-sm-inline-block">
          <b><?php echo $_settings->info('short_name') ?> (De: <a href="mailto:oretnom23@gmail.com" target="blank">CasaGrande</a> )</b> v1.0
        </div>
      </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <div class="jqvmap-label" style="display: none; left: 1093.83px; top: 394.361px;">TC</div>