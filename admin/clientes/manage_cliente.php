<?php 
if(isset($_GET['id'])){
	$cliente = $conn->query("SELECT * FROM clientes where id ='{$_GET['id']}'");
	foreach($cliente->fetch_array() as $k =>$v){
		if(!is_numeric($k))
			$$k = $v;
	}
}
...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-cliente">	
				...
				<div class="row">
					<div class="col-md-4">
						<label for="firstname" class="control-label">Nombres <sup>*</sup></label>
					...
					<div class="col-md-4">
						<label for="middlename" class="control-label">Apellido paterno </label>
					...
					<div class="col-md-4">
						<label for="lastname" class="control-label">Apellido Materno <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-4">
						<label for="gender" class="control-label">Género <sup>*</sup></label>
					...
					<div class="col-md-4">
						<label for="contact" class="control-label">N° de Celular <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-12">
						<label for="address" class="control-label">Dirección <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-6">
						<label for="email" class="control-label">Correo <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-6">
						<label for="password" class="control-label">Nueva Contraseña <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="custom-file custom-file-sm rounded-0">
							...
							<label class="custom-file-label rounded-0" for="customFile">Elija el archivo</label>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-4">
						<label for="status" class="control-label">Estado <sup>*</sup></label>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-cliente">Actualizar</button>
				</div>
			</div>
		</div>
</div>
...
<script>
	...
	$('#manage-cliente').submit(function(e){
        ...
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Users.php?f=save_cliente",
